...
public class PrismaComponent extends BaseComponent {
     ...
     */
    public PrismaComponent(BaseComponent... extras) {
        this();
        if (extras.length == 0) {
            return;
        }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof PrismaComponent)) return false;
        final PrismaComponent other = (PrismaComponent) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof PrismaComponent;
    }
